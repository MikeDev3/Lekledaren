...
export class AuthService extends IonicAuth {
  ...
  private async addConfig() {
    ...
    const redirectUri = this.onDevice() ? 'com.okta.dev-598005:/callback' : 'https://lekledaren-65e2b.firebaseapp.com/implicit/callback';
    const logoutRedirectUri = this.onDevice() ? 'com.okta.dev-598005:/logout' : 'https://lekledaren-65e2b.firebaseapp.com/implicit/logout';
    const clientId = '0oat6v1wiVamgoQHM4x5';
    const issuer = 'https://dev-598005.okta.com/oauth2/default';
